<template>
  <div class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-md text-center flex flex-col items-center">
      <img
        src="../../assets/alquran_web.png"
        alt="alquran"
        class="w-40 md:w-48 lg:w-56 mb-4"
      />
      ...
      <button
        @click="navigateToQuranList"
        class="w-full mt-6 bg-primary text-white font-semibold py-3 rounded-full hover:opacity-90 transition"
      >
        Baca Sekarang
      </button>
    </div>
