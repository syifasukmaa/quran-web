...
<template>
        ...
        <div class="relative -mt-[75px] z-10 px-4 lg:px-28">
            <div class="bg-transparent rounded-t-3xl px-4 pt-4">
                <div class="flex justify-between items-center mb-6">
                    <div @click="router.push('/quran/doa')" class="flex items-center gap-2 cursor-pointer">
    ...
    <div class="px-4 lg:px-28 mt-15">
        <div class="rounded-2xl w-full h-[180px] relative overflow-hidden">
            <img src="../../../assets/sunandcloud.jpg" alt="sunandcloud" class="h-full w-full object-cover" />
        ...
        <div class="bg-white drop-shadow-lg drop-shadow-gray-400/20 rounded-2xl px-5 py-4 mt-6 mb-6">
            ...
            <div class="flex items-center gap-3">
                <span class="bg-gray-200 px-3 py-1 rounded-full capitalize text-black text-xs font-semibold" v-for="doa in doaStore.doaDetail.tag"> #{{ doa }} </span>
            </div>
        </div>
    </div>
</template>
